...
export const ServiceSelector: React.FC<ServiceSelectorProps> = ({ selectedServices, onServiceChange }) => {
    ...
    return (
        <div>
            <h2 className="text-xl font-semibold mb-4 text-brand">Elige tus servicios</h2>
                    ...
                    >
                        <div className="flex justify-between items-start">
                            <div className="flex items-center">
                                <h3 className="font-bold text-brand">{service.name}</h3>
                         ...
                         <p className="text-sm mt-1 text-brand/80">{service.description}</p>
                        <div className="text-sm mt-2 text-brand/90">
