                ...
                <div className="mt-4">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                        {BRANDING_PRESETS.map(preset => (
                            <button key={preset.name} onClick={() => applyPreset(preset.colors)} className="px-3 py-1.5 border rounded-md text-sm hover:bg-gray-100">
                                {preset.name}
                            </button>
                        ))}
                    </div>
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            ...
                            />
                            <input type="text" name="primaryColor" value={business.branding.primaryColor} onChange={handleBrandingChange} className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <input
                                ...
                                className="h-10 w-10 p-1 border border-gray-300 rounded-md cursor-pointer"
                            />
                             <input type="text" name="secondaryColor" value={business.branding.secondaryColor} onChange={handleBrandingChange} className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <input
                                ...
                                className="h-10 w-10 p-1 border border-gray-300 rounded-md cursor-pointer"
                            />
                            <input type="text" name="textColor" value={business.branding.textColor} onChange={handleBrandingChange} className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" />
                        </div>
                    </div>
                    <div>
